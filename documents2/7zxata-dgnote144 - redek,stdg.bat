...
C:\p\1ziptar\7-Zip\7z.exe a -y -t7z  -xr!templates_c -xr!.svn  "c:\backup\dgnote144\dgnote144.xata.%dhms%.%computername%.7z" C:\p2\xampp\htdocs\dgnote144 
copy "c:\backup\dgnote144\dgnote144.xata.%dhms%.%computername%.7z" "C:\n\Dropbox\csd\copyof\dgnote130,tagger\dgnote144.xata.latest.%computername%.7z"
